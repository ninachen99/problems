...
def over_lapping_rectangles(strArr)
  # find out if there is overlapping
  # cal the overlapping area
  # cal the first rec area
  # compare the first rec and overlapping area.
  
         
end
   
# keep this function call here    
over_lapping_rectangles(STDIN.gets)  
