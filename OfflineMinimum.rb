#Using the Ruby language, have the function OffLineMinimum(strArr) 
#take the strArr parameter being passed which will be an array of 
#integers ranging from 1...n and the letter "E" and return the correct subset 
#based on the following rules. The input will be in the following format: 
...
#then your program should return 4,1,5. # why 3 and 2 was not returned????
